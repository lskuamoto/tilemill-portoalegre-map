...
#water_areas, #water_areas_0, #water_areas_1,
#ocean {
  polygon-fill:@water;
...
#landusages [zoom>6], #landusages_0 [zoom>6], #landusages_1 [zoom>6] {
  [type='forest'],
  [type='wood'] {
    polygon-fill:@park;
...
#landusages [zoom>=12], #landusages_0 [zoom>=12], #landusages_1 [zoom>=12] {
  [type='school'],
  [type='college'],
  [type='university'] {
    polygon-fill: @school;
